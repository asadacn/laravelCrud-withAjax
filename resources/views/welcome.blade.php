...
font-family: Nunito
    ...
    <body>
       <div class="container p-4">
           <h1 class="display-3 text-muted">Laravel Crud - Contact App</h1>
           <div class="card">
               <div class="card-body">
            <div class="form-row mb-2">
                <div class="col-auto mb-2"> <a class="btn  btn-success border" href="#" data-toggle="modal" data-target="#staticBackdrop" >ADD</a></div>
